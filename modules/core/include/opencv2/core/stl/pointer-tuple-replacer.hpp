...
template <typename T> constexpr auto replace_cv_it(cv::MatConstIterator_<T> it) -> T * { return (T *)it.ptr; }
...
constexpr auto make_tpl_replaced(T1 t1) -> decltype(std::make_tuple(replace_single_element(t1))) {
  return std::make_tuple(replace_single_element(t1));
}

template <typename T1, typename T2>
constexpr auto make_tpl_replaced(T1 t1, T2 t2)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2))) {
...
constexpr auto make_tpl_replaced(T1 t1, T2 t2, T3 t3)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3))) {
  return std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3));
}
...
constexpr auto make_tpl_replaced(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                                replace_single_element(t4), replace_single_element(t5))) {
  return std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                         replace_single_element(t4), replace_single_element(t5));
}

template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
constexpr auto make_tpl_replaced(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                                replace_single_element(t4), replace_single_element(t5), replace_single_element(t6))) {
  return std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                         replace_single_element(t4), replace_single_element(t5), replace_single_element(t6));
}
...
template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,
          typename T9>
constexpr auto make_tpl_replaced(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                                replace_single_element(t4), replace_single_element(t5), replace_single_element(t6),
                                replace_single_element(t7), replace_single_element(t8), replace_single_element(t9))) {
  return std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                         replace_single_element(t4), replace_single_element(t5), replace_single_element(t6),
                         replace_single_element(t7), replace_single_element(t8), replace_single_element(t9));
}
...
constexpr auto make_tpl_replaced(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10)
    -> decltype(std::make_tuple(replace_single_element(t1), replace_single_element(t2), replace_single_element(t3),
                                replace_single_element(t4), replace_single_element(t5), replace_single_element(t6),
                                replace_single_element(t7), replace_single_element(t8), replace_single_element(t9),
